...
Server Room:
* Hack servers: opens command map, options are like Play Checkers, Chess, Thermonuclear War
* Laser detectors: if trip, or otherwise alarm goes off, gas the room
*/
