...
MissionRegItem(Items, "Repair Patch", RepairPatch, 1);
//
//
//
...
MissionRegObject( Misc, "Powered Elec. Beam", MissionCreateObject, PoweredElectroBeam, StaticShape, PoweredElectricalBeam );
//
//
//
