// Modified maxDamages by x100, and removed shields
...
// Rocket Turret is now moutable and is in misc\mountableTurret.cs
...
function Turret::onDestroyed(%this)
{
	...
	calcRadiusDamage(%this, $DebrisDamageType, 2.5, 100, 25, 9, 3, 0.40, 
		0.1, 200, 100); 
}
...
function Turret::onDamage(%this,%type,%value,%pos,%vec,%mom,%object)
{
   if(%this.objectiveLine)
		%this.lastDamageTeam = GameBase::getApparentTeam(%object);
	%TDS= 1;
